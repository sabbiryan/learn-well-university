...
namespace LearnWellUniversity.Infrastructure.Persistences.Migrations
{
    ...
    [Migration("20250813180844_RefreshToken_Entity_Added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.Auths.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.Auths.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.CourseClass", b =>
                {
                    ...
                    b.Property<int?>("EnrollmentStaffId")
                        .HasColumnType("integer")
                        .HasColumnName("enrollment_staff_id");
                    ...
                    b.HasIndex("EnrollmentStaffId")
                        .HasDatabaseName("ix_course_classes_enrollment_staff_id");
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.StudentClass", b =>
                {
                    ...
                    b.HasIndex("EnrollmentStaffId")
                        .HasDatabaseName("ix_student_classes_enrollment_staff_id");
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.StudentCourse", b =>
                {
                    ...
                    b.HasIndex("EnrollmentStaffId")
                        .HasDatabaseName("ix_student_courses_enrollment_staff_id");
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.Auths.RoleResource", b =>
                {
                    ...
                    b.HasOne("LearnWellUniversity.Domain.Entities.Auths.Role", "Role")
                        .WithMany("RoleResources")
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.CourseClass", b =>
                {
                    ...
                    b.HasOne("LearnWellUniversity.Domain.Entities.Staff", "EnrollmentStaff")
                        .WithMany("CourseClasses")
                        .HasForeignKey("EnrollmentStaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_course_classes_staffs_enrollment_staff_id");

                    b.Navigation("Class");

                    b.Navigation("Course");

                    b.Navigation("EnrollmentStaff");
                });
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.StudentClass", b =>
                {
                    ...
                    b.HasOne("LearnWellUniversity.Domain.Entities.Staff", "EnrollmentStaff")
                        ...
                        .HasForeignKey("EnrollmentStaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_student_classes_staffs_enrollment_staff_id");
            ...
            modelBuilder.Entity("LearnWellUniversity.Domain.Entities.StudentCourse", b =>
                {
                    ...
                    b.HasOne("LearnWellUniversity.Domain.Entities.Staff", "EnrollmentStaff")
                        ...
                        .HasForeignKey("EnrollmentStaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_student_courses_staffs_enrollment_staff_id");
