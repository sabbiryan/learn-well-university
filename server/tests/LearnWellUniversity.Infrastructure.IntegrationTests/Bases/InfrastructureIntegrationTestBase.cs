...
namespace LearnWellUniversity.Infrastructure.IntegrationTests.Bases
{
    public abstract class InfrastructureIntegrationTestBase : IClassFixture<InfrastructureIntegrationTestFixture>, IAsyncDisposable
    {
        ...
        public InfrastructureIntegrationTestBase(InfrastructureIntegrationTestFixture fixture)
        {
